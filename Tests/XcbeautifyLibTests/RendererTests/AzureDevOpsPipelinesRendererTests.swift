...
@Suite struct AzureDevOpsPipelinesRendererTests {
    ...
    @Test func createUniversalBinary() {
        ...
        #expect(formatted == "[BackyardBirdsDataTarget] Create Universal Binary BackyardBirdsData.o")
    }
    ...
    @Test func compileAssetCatalog() {
        ...
        #expect(formatted == "[Backyard Birds] Compile Asset Catalog Assets.xcassets")
    }
    ...
    @Test func generateAssetSymbols() {
        ...
        #expect(formatted == "[Backyard Birds] Generate Asset Symbols An_Asset_Catalog.xcassets")
    }
    ...
    @Test func swiftTestingParameterizedTestFailed() {
        ...
        let formatted = logFormatted(input)
        let expectedOutput = "##vso[task.logissue type=error]\"Named Parameterized Failing\" with 1 test case (0.001 seconds) 1 issue(s)"
        #expect(formatted == expectedOutput)
    }
